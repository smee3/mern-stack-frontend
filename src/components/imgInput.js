...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        try {
            ...
            data.append("upload_preset", "z5z3xwjb")
            data.append("cloud_name", "dzrhb2n7f")
            const response = await fetch("https://api.cloudinary.com/v1_1/dzrhb2n7f/image/upload", {method: "POST", body: data})
